...
course1 = program1.courses.build(name: "Ruby", description: "An intro to Ruby", length_in_hours: 150)
course2 = program1.courses.build(name: "Sinatra", description: "Sinatra, SQL, ActiveRecord", length_in_hours: 150)
course3 = program1.courses.build(name: "Rails", description: "Put it all together in Ruby on Rails", length_in_hours: 150)
course4 = program1.courses.build(name: "Rails and JavaScript", description: "Learn JS to take the next step", length_in_hours: 150)
course5 = program1.courses.build(name: "React and Redux", description: "Full Stack JS Development", length_in_hours: 150)
course6 = program2.courses.build(name: "Principles of Software Design", description: "Java OO and beyond", length_in_hours: 50)
course7 = program2.courses.build(name: "Solving Problems with Software", description: "Intro to Java", length_in_hours: 40)
course8 = program2.courses.build(name: "Arrays, Lists, and Structured Data", description: "Java data structures", length_in_hours: 40)
course9 = program3.courses.build(name: "Programming for Everybody", description: "Python 101", length_in_hours: 20)
course10 = program3.courses.build(name: "Python Data Structures", description: "Lists, dictionaries and more", length_in_hours: 30)
course11 = program3.courses.build(name: "Using Databases with Python", description: "Using SQL with Python", length_in_hours: 30)
course12 = program4.courses.build(name: "Developing Android Apps", description: "Learn to build apps", length_in_hours: 80)
course13 = program4.courses.build(name: "Advanced Android Development", description: "Add responsiveness to your apps", length_in_hours: 80)
course14 = program4.courses.build(name: "Gradle For Android and Java", description: "Learn Gradle Builds", length_in_hours: 80)
